...
export default function HomePage(){
  ...
  const renderedPackages = featuredPackages.map((pack) => {
    return <div className=" flex flex-col justify-between gap-3 border rounded shadow p-4">
      <div className=" flex flex-col gap-1 border-gray-400">
  ...
  return <div className=" container py-12 space-y-8">
    ...
    <div className=" mx-auto grid grid-cols-4 gap-3 max-w-[900px] items-stretch">
      {renderedPackages}
    </div>
  </div>
}